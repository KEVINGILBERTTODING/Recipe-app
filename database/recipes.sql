...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2022 at 12:05 PM
...
(1, 'Kandean is a recipe sharing application, which aims to make it easier to store our favorite recipes or to share our recipes with others, with a modern design. This application will continue to be developed by Kevin Gilbert Toding as a developer.', '2.1.0');
...
(110, 5, 2, '😋😍', '2022-08-28', '07:59:40'),
(112, 2, 2, 'enakk', '2022-08-28', '22:34:09'),
(114, 2, 6, 'testadmin', '2022-09-03', '07:32:40');
...
(4, 4, '', 'halooo test chat pertama', '4-2022-08-19-.png', '2022-08-19', '05:30:57', 2),
...
(6, 2, '', 'ddsdsdwewewee', '', 10, '2022-08-19', '22:08:09', 1),
(11, 2, 'testss', 'yaaaaaaa', '2-2022-08-31-11.png', 9, '2022-08-31', '12:01:11', 1);
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password`, `date`, `time`, `photo_profile`, `biography`, `role`, `active`) VALUES
(2, 'Chika Chelsea', 'zeruya@gmail.com', '$2y$10$6pJk0gcDyPaPKTghhW8wN.Bw4tXQK3JEXGP1I93qTjXyv8RhaEnp6', '23-07-2022', '15:16:23', '2.png', 'I love cooking 😍', 2, 1),
(4, 'Kevin Gilbert', 'gwareshop@gmail.com', '$2y$10$sVD6yM/NE5CnXMZ9wK2WueqeKF.BkBEFgFk9rVK4nrrZ2O6hWj8Ni', '23-07-2022', '15:20:03', 'default.png', '', 1, 1),
(6, 'Super Admin', 'superadmin@gmail.com', '$2y$10$7b65g9mv6KKLDcprJJfZiOltw2.WNquSTsKl8zj15wOpfK85QM3ky', '22-08-2022', '06:19:00', '6.png', '', 1, 1),
(8, 'natalia', 'natalia@gmail.com', '$2y$10$vhAQRqBCdjQDRa91nSu5M.MEztFdhZHtmJBPbWg6N/qjc3Oc2JlPW', '28-08-2022', '09:27:09', 'default.png', '', 1, 1),
(18, 'nellan', 'natalia2', '$2y$10$j/p0p.xJe3S8eyQstOc5G.GeAe7uzlmqlBQvmU10p2QIMnpLiyVgm', '23', '40', 'default.png', '', 1, 1),
(19, 'sabrina', 'kevin@gmail.com', '$2y$10$G6J.YHQ6nUHwELdjCSiAcOX1iXiQaFA4nxz9uhdr.REXcrlS7/D/S', '28-08-2022', '10:36:48', 'default.png', '', 1, 1);
...
--
ALTER TABLE `comments`
  MODIFY `comment_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `liked`
--
ALTER TABLE `liked`
  MODIFY `like_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;
...
--
ALTER TABLE `saved`
  MODIFY `save_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
