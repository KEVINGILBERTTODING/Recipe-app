...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 12:08 AM
...
(99, 5, 2, 'hahahahha', '2022-08-08', '15:21:43'),
...
(2, 'Eve Ichwan', 'eve12345', '38adbdb825dbf4601a6fc697515c88c4', '23-07-2022', '15:16:23', '2.png', 'hhahaha'),
...
--
ALTER TABLE `liked`
  MODIFY `like_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;
...
--
ALTER TABLE `saved`
  MODIFY `save_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
