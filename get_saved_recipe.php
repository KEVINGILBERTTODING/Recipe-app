...
u.username, u.photo_profile, u.email, s.recipe_id from recipe r, users u, saved s where r.recipe_id = s.recipe_id and r.user_id= u.user_id and s.user_id = '$user_id' and r.status='1' order by s.save_id desc";
